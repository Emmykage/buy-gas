...
export const blogs = [
    ...
    //       </ul>
    //       <h2 class="my-4 text-lg font-medium" >Why Choose ValentPhama Services?</h2>
    //       <ul> 
    //       <li> 
    ...
    //       <p>
    // Let ValentPhama Services Help Your Business Succeed.
    ...
    <p className="text-xl font-bold">Corporate tax can be a daunting subject for small business owners in the UK, but understanding how it works is essential for staying compliant and optimizing your financial position. At ValentPhama Services, we specialize in helping small businesses navigate the complexities of UK corporate tax. Let’s dive into the basics of corporate tax and how it affects your business.</p>
      ...
      <p>At ValentPhama Services, we specialize in tax planning and corporate tax compliance for small businesses. Our team ensures you meet deadlines, claim all available deductions, and minimize your tax liabilities.</p>
  ...
  }, 
  {
    ...
    <p className="text-xl font-bold">Selecting the right accounting software is crucial for managing your business's finances efficiently. In this guide, we’ll explore the key factors to consider when choosing software for your small business and why it's essential for growth.</p>
      ...
      <p>
        At ValentPhama Services, we help businesses implement and optimize the right accounting software for their unique needs
   ...
   CTA: {
    isAvailable: true,
    textBody: "At ValentPhama Services, we help businesses implement and optimize the right accounting software for their unique needs",
  ...
  }, 
  {
    ...
    <p className="text-xl font-bold">Corporate tax can be a daunting subject for small business owners in the UK, but understanding how it works is essential for staying compliant and optimizing your financial position. At ValentPhama Services, we specialize in helping small businesses navigate the complexities of UK corporate tax. Let’s dive into the basics of corporate tax and how it affects your business.</p>
     ...
     <div>
      ...
      <p>
        At ValentPhama Services, we provide reliable and cost-effective payroll outsourcing services that ensure compliance and accuracy. 
  ...
  <div>
      ...
      <p>
        At ValentPhama Services, we provide expert financial consultancy and cash flow management advice to help your business thrive
