...
const FooterInfo = () => (
  <section className="mt-10">
    <div className="grid grid-cols-2 my-10 md:grid-cols-4 xl:grid-cols-info-bottom">
      <div className="md:border border-gray-300 h-40 flex flex-col justify-center items-center md:shadow py-6 text-center">
        <img src={delivery} alt="" />
        <p className="text-base font-medium">Free Delivery over NGN300000</p>

      </div>
      <div className="md:border  border-gray-300 flex flex-col justify-center items-center md:shadow py-6 text-center">
        <img src={payment} alt="" />
